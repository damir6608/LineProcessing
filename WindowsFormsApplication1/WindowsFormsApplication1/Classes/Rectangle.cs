...
namespace WindowsFormsApplication1
{
    ...
    {
        public Rectangle(int x, int y, int w, int h, float penSize, Color color)
        {
            this.CoordX = x;
            this.CoordY = y;
            this.FigureWidth = w;
            this.FigureHeight = h;
            this.FigureName = "Прямоугольник " + Convert.ToString(Init.rectanglesNumber);
        ...
        public override void DrawFigure()
        {
            ...
            graphics.DrawRectangle(Init.pen, CoordX, CoordY, FigureWidth, FigureHeight);
